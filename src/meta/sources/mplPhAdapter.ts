...
export class MplPhAdapter extends AbstractMetaDataSource implements ProDataSource {
  readonly id = 'mpl-philippines';
  readonly name = 'MPL Philippines';
  readonly category = 'PRO' as const;
  readonly mode = 'UNAVAILABLE' as const;
  readonly confidence: SourceConfidence = 'official';
  readonly sourceUrl = 'https://ph-mpl.com/matches';
  readonly description = 'Official MPL Philippines tournament telemetry and pick/ban match logs.';
